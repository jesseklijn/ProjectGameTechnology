...
{
	const auto movementSpeed = static_cast<float>(0.25);
	const auto rotationSpeed = static_cast<float>(25);
	...
	auto camera = smgr->addCameraSceneNodeFPS(0, rotationSpeed, movementSpeed, -100, keyMap, 4);
